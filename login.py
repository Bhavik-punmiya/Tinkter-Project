...
class Login:
    ...
    def loginFunc(self):
        if self.txtUsername.get() == 'admin' and self.txtPassword.get() == 'admin':
            ...
            admin2.AdminControls(self.root)
    ...
    def loginControlFrame(self):
        ...
        self.labelCompanyName = Label(self.rightFrame, text="DJ Sanghvi College", font=("Goudy Old Style", 55),
                                      bg="#5856a0",
                                      fg="white")
        self.labelCompanyName.grid(row=0, column=2, columnspan=2, padx=10)
        self.labelDesc = Label(self.rightFrame, text="Creating Wingineers", font=("Times New Roman", 25, "italic"),
                               bg="#5856a0",
                               fg="white")
